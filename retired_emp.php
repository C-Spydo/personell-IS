...
<div class="container instaFade">
    ...
    <span class="goback" ><a href="home.php">Go back to Home&nbsp;<span></span></a></span>
    	...
    	<div class="emp">
			...
			<div class="emp_label">Retired Employee</div>
			...
			<table class="emp_table" data-toggle="table" data-url="" data-show-toggle="true"   data-search="true"  data-pagination="true" data-sort-name="name" >
					...
					?>
							<tr>
								...
								<td width="3%"><a href="emp_details.php"><?php echo $mySerial ?></a></td>
								<td width="42%"><a href="emp_details.php"><?php echo $realname?></a></td>
								<td width="18%" ><a href="emp_details.php"><?php echo $row['staffid']?></a></td>
					...
					<?php  
						...
						?>
							<td width="18%" ><a href="emp_details.php"><?php echo $row['presentministry'] ?></a> </td>
